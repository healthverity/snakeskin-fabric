...
# source: snakeskin/protos/peer/transaction.proto
...
_PROCESSEDTRANSACTION.fields_by_name['transactionEnvelope'].message_type = snakeskin_dot_protos_dot_common_dot_common__pb2._ENVELOPE
...
_CHAINCODEENDORSEDACTION.fields_by_name['endorsements'].message_type = snakeskin_dot_protos_dot_peer_dot_proposal__response__pb2._ENDORSEMENT
...
SignedTransaction = _reflection.GeneratedProtocolMessageType('SignedTransaction', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.peer.transaction_pb2'
  # @@protoc_insertion_point(class_scope:protos.SignedTransaction)
  })
_sym_db.RegisterMessage(SignedTransaction)

ProcessedTransaction = _reflection.GeneratedProtocolMessageType('ProcessedTransaction', (_message.Message,), {
...
TransactionAction = _reflection.GeneratedProtocolMessageType('TransactionAction', (_message.Message,), {
...
ChaincodeActionPayload = _reflection.GeneratedProtocolMessageType('ChaincodeActionPayload', (_message.Message,), {
...
ChaincodeEndorsedAction = _reflection.GeneratedProtocolMessageType('ChaincodeEndorsedAction', (_message.Message,), {
