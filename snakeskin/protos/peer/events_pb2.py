...
# source: snakeskin/protos/peer/events.proto
...
_FILTEREDTRANSACTION.fields_by_name['type'].enum_type = snakeskin_dot_protos_dot_common_dot_common__pb2._HEADERTYPE
_FILTEREDTRANSACTION.fields_by_name['tx_validation_code'].enum_type = snakeskin_dot_protos_dot_peer_dot_transaction__pb2._TXVALIDATIONCODE
...
_FILTEREDCHAINCODEACTION.fields_by_name['chaincode_event'].message_type = snakeskin_dot_protos_dot_peer_dot_chaincode__event__pb2._CHAINCODEEVENT
_DELIVERRESPONSE.fields_by_name['status'].enum_type = snakeskin_dot_protos_dot_common_dot_common__pb2._STATUS
_DELIVERRESPONSE.fields_by_name['block'].message_type = snakeskin_dot_protos_dot_common_dot_common__pb2._BLOCK
...
FilteredBlock = _reflection.GeneratedProtocolMessageType('FilteredBlock', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.peer.events_pb2'
...
_DELIVER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=snakeskin_dot_protos_dot_common_dot_common__pb2._ENVELOPE,
