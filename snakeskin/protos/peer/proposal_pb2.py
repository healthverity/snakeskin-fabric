...
# source: snakeskin/protos/peer/proposal.proto
...
from snakeskin.protos.peer import chaincode_pb2 as snakeskin_dot_protos_dot_peer_dot_chaincode__pb2
...
_CHAINCODEHEADEREXTENSION.fields_by_name['chaincode_id'].message_type = snakeskin_dot_protos_dot_peer_dot_chaincode__pb2._CHAINCODEID
...
_CHAINCODEACTION.fields_by_name['response'].message_type = snakeskin_dot_protos_dot_peer_dot_proposal__response__pb2._RESPONSE
_CHAINCODEACTION.fields_by_name['chaincode_id'].message_type = snakeskin_dot_protos_dot_peer_dot_chaincode__pb2._CHAINCODEID
_CHAINCODEACTION.fields_by_name['token_expectation'].message_type = snakeskin_dot_protos_dot_token_dot_expectations__pb2._TOKENEXPECTATION
...
SignedProposal = _reflection.GeneratedProtocolMessageType('SignedProposal', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.peer.proposal_pb2'
