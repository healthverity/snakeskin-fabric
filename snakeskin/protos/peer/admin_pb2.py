...
# source: snakeskin/protos/peer/admin.proto
...
ServerStatus = _reflection.GeneratedProtocolMessageType('ServerStatus', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.peer.admin_pb2'
...
LogSpecRequest = _reflection.GeneratedProtocolMessageType('LogSpecRequest', (_message.Message,), {
...
LogSpecResponse = _reflection.GeneratedProtocolMessageType('LogSpecResponse', (_message.Message,), {
...
AdminOperation = _reflection.GeneratedProtocolMessageType('AdminOperation', (_message.Message,), {
