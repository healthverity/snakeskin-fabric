...
from snakeskin.protos.peer import admin_pb2 as snakeskin_dot_protos_dot_peer_dot_admin__pb2
...
class AdminStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetStatus = channel.unary_unary(
        ...
        response_deserializer=snakeskin_dot_protos_dot_peer_dot_admin__pb2.ServerStatus.FromString,
        )
    ...
    self.GetModuleLogLevel = channel.unary_unary(
        ...
        request_serializer=snakeskin_dot_protos_dot_common_dot_common__pb2.Envelope.SerializeToString,
        response_deserializer=snakeskin_dot_protos_dot_peer_dot_admin__pb2.LogLevelResponse.FromString,
        )
    ...
    self.GetLogSpec = channel.unary_unary(
        ...
        request_serializer=snakeskin_dot_protos_dot_common_dot_common__pb2.Envelope.SerializeToString,
        response_deserializer=snakeskin_dot_protos_dot_peer_dot_admin__pb2.LogSpecResponse.FromString,
        )
...
def add_AdminServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetStatus': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=snakeskin_dot_protos_dot_peer_dot_admin__pb2.ServerStatus.SerializeToString,
      ),
      ...
      'GetModuleLogLevel': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=snakeskin_dot_protos_dot_common_dot_common__pb2.Envelope.FromString,
          response_serializer=snakeskin_dot_protos_dot_peer_dot_admin__pb2.LogLevelResponse.SerializeToString,
      ),
      ...
      'GetLogSpec': grpc.unary_unary_rpc_method_handler(
          servicer.GetLogSpec,
          request_deserializer=snakeskin_dot_protos_dot_common_dot_common__pb2.Envelope.FromString,
          response_serializer=snakeskin_dot_protos_dot_peer_dot_admin__pb2.LogSpecResponse.SerializeToString,
      ),
