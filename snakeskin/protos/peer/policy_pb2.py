...
# source: snakeskin/protos/peer/policy.proto
...
_APPLICATIONPOLICY.fields_by_name['signature_policy'].message_type = snakeskin_dot_protos_dot_common_dot_policies__pb2._SIGNATUREPOLICYENVELOPE
...
ApplicationPolicy = _reflection.GeneratedProtocolMessageType('ApplicationPolicy', (_message.Message,), {
  'DESCRIPTOR' : _APPLICATIONPOLICY,
  '__module__' : 'snakeskin.protos.peer.policy_pb2'
