...
# source: snakeskin/protos/peer/chaincode.proto
...
_CHAINCODEDATA.fields_by_name['policy'].message_type = snakeskin_dot_protos_dot_common_dot_policies__pb2._SIGNATUREPOLICYENVELOPE
_CHAINCODEDATA.fields_by_name['data'].message_type = _CDSDATA
_CHAINCODEDATA.fields_by_name['instantiation_policy'].message_type = snakeskin_dot_protos_dot_common_dot_policies__pb2._SIGNATUREPOLICYENVELOPE
...
ChaincodeID = _reflection.GeneratedProtocolMessageType('ChaincodeID', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.peer.chaincode_pb2'
...
ChaincodeInput = _reflection.GeneratedProtocolMessageType('ChaincodeInput', (_message.Message,), {
  ...
  'DecorationsEntry' : _reflection.GeneratedProtocolMessageType('DecorationsEntry', (_message.Message,), {
...
ChaincodeSpec = _reflection.GeneratedProtocolMessageType('ChaincodeSpec', (_message.Message,), {
...
ChaincodeDeploymentSpec = _reflection.GeneratedProtocolMessageType('ChaincodeDeploymentSpec', (_message.Message,), {
...
ChaincodeInvocationSpec = _reflection.GeneratedProtocolMessageType('ChaincodeInvocationSpec', (_message.Message,), {
...
CDSData = _reflection.GeneratedProtocolMessageType('CDSData', (_message.Message,), {
  'DESCRIPTOR' : _CDSDATA,
  '__module__' : 'snakeskin.protos.peer.chaincode_pb2'
...
ChaincodeData = _reflection.GeneratedProtocolMessageType('ChaincodeData', (_message.Message,), {
