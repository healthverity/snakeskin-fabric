...
# source: snakeskin/protos/orderer/kafka.proto
...
KafkaMessage = _reflection.GeneratedProtocolMessageType('KafkaMessage', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.orderer.kafka_pb2'
  # @@protoc_insertion_point(class_scope:orderer.KafkaMessage)
  })
_sym_db.RegisterMessage(KafkaMessage)

KafkaMessageRegular = _reflection.GeneratedProtocolMessageType('KafkaMessageRegular', (_message.Message,), {
...
KafkaMessageTimeToCut = _reflection.GeneratedProtocolMessageType('KafkaMessageTimeToCut', (_message.Message,), {
...
KafkaMessageConnect = _reflection.GeneratedProtocolMessageType('KafkaMessageConnect', (_message.Message,), {
...
KafkaMetadata = _reflection.GeneratedProtocolMessageType('KafkaMetadata', (_message.Message,), {
