...
# source: snakeskin/protos/orderer/configuration.proto
...
ConsensusType = _reflection.GeneratedProtocolMessageType('ConsensusType', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.orderer.configuration_pb2'
