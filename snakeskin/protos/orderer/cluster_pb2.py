...
# source: snakeskin/protos/orderer/cluster.proto
...
_SUBMITREQUEST.fields_by_name['content'].message_type = snakeskin_dot_protos_dot_common_dot_common__pb2._ENVELOPE
_SUBMITRESPONSE.fields_by_name['status'].enum_type = snakeskin_dot_protos_dot_common_dot_common__pb2._STATUS
...
StepRequest = _reflection.GeneratedProtocolMessageType('StepRequest', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.orderer.cluster_pb2'
