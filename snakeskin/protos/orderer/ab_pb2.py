...
# source: snakeskin/protos/orderer/ab.proto
...
_BROADCASTRESPONSE.fields_by_name['status'].enum_type = snakeskin_dot_protos_dot_common_dot_common__pb2._STATUS
...
BroadcastResponse = _reflection.GeneratedProtocolMessageType('BroadcastResponse', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.orderer.ab_pb2'
