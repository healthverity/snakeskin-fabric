...
# source: snakeskin/protos/token/expectations.proto
...
_PLAINTOKENEXPECTATION.fields_by_name['outputs'].message_type = snakeskin_dot_protos_dot_token_dot_transaction__pb2._PLAINOUTPUT
...
TokenExpectation = _reflection.GeneratedProtocolMessageType('TokenExpectation', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.token.expectations_pb2'
