...
# source: snakeskin/protos/token/prover.proto
...
_TOKENOUTPUT.fields_by_name['id'].message_type = snakeskin_dot_protos_dot_token_dot_transaction__pb2._INPUTID
...
_TRANSFERREQUEST.fields_by_name['token_ids'].message_type = snakeskin_dot_protos_dot_token_dot_transaction__pb2._INPUTID
_TRANSFERREQUEST.fields_by_name['shares'].message_type = _RECIPIENTTRANSFERSHARE
_REDEEMREQUEST.fields_by_name['token_ids'].message_type = snakeskin_dot_protos_dot_token_dot_transaction__pb2._INPUTID
_APPROVEREQUEST.fields_by_name['allowance_shares'].message_type = _ALLOWANCERECIPIENTSHARE
_APPROVEREQUEST.fields_by_name['token_ids'].message_type = snakeskin_dot_protos_dot_token_dot_transaction__pb2._INPUTID
_EXPECTATIONREQUEST.fields_by_name['expectation'].message_type = snakeskin_dot_protos_dot_token_dot_expectations__pb2._TOKENEXPECTATION
_EXPECTATIONREQUEST.fields_by_name['token_ids'].message_type = snakeskin_dot_protos_dot_token_dot_transaction__pb2._INPUTID
...
_COMMANDRESPONSE.fields_by_name['token_transaction'].message_type = snakeskin_dot_protos_dot_token_dot_transaction__pb2._TOKENTRANSACTION
...
TokenToIssue = _reflection.GeneratedProtocolMessageType('TokenToIssue', (_message.Message,), {
  'DESCRIPTOR' : _TOKENTOISSUE,
  '__module__' : 'snakeskin.protos.token.prover_pb2'
  # @@protoc_insertion_point(class_scope:token.TokenToIssue)
  })
_sym_db.RegisterMessage(TokenToIssue)

RecipientTransferShare = _reflection.GeneratedProtocolMessageType('RecipientTransferShare', (_message.Message,), {
...
TokenOutput = _reflection.GeneratedProtocolMessageType('TokenOutput', (_message.Message,), {
...
UnspentTokens = _reflection.GeneratedProtocolMessageType('UnspentTokens', (_message.Message,), {
...
AllowanceRecipientShare = _reflection.GeneratedProtocolMessageType('AllowanceRecipientShare', (_message.Message,), {
...
ExpectationRequest = _reflection.GeneratedProtocolMessageType('ExpectationRequest', (_message.Message,), {
...
SignedCommandResponse = _reflection.GeneratedProtocolMessageType('SignedCommandResponse', (_message.Message,), {
