...
class ProverStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ProcessCommand = channel.unary_unary(
        ...
        request_serializer=snakeskin_dot_protos_dot_token_dot_prover__pb2.SignedCommand.SerializeToString,
        response_deserializer=snakeskin_dot_protos_dot_token_dot_prover__pb2.SignedCommandResponse.FromString,
        )
...
def add_ProverServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ProcessCommand': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=snakeskin_dot_protos_dot_token_dot_prover__pb2.SignedCommand.FromString,
          response_serializer=snakeskin_dot_protos_dot_token_dot_prover__pb2.SignedCommandResponse.SerializeToString,
      ),
  }
