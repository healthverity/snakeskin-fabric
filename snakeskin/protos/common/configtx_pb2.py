...
# source: snakeskin/protos/common/configtx.proto
...
_CONFIGENVELOPE.fields_by_name['last_update'].message_type = snakeskin_dot_protos_dot_common_dot_common__pb2._ENVELOPE
...
_CONFIGPOLICY.fields_by_name['policy'].message_type = snakeskin_dot_protos_dot_common_dot_policies__pb2._POLICY
...
ConfigEnvelope = _reflection.GeneratedProtocolMessageType('ConfigEnvelope', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.common.configtx_pb2'
  # @@protoc_insertion_point(class_scope:common.ConfigEnvelope)
  })
_sym_db.RegisterMessage(ConfigEnvelope)

ConfigGroupSchema = _reflection.GeneratedProtocolMessageType('ConfigGroupSchema', (_message.Message,), {
...
ConfigValueSchema = _reflection.GeneratedProtocolMessageType('ConfigValueSchema', (_message.Message,), {
...
ConfigPolicySchema = _reflection.GeneratedProtocolMessageType('ConfigPolicySchema', (_message.Message,), {
