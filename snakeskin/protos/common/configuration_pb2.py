...
# source: snakeskin/protos/common/configuration.proto
...
HashingAlgorithm = _reflection.GeneratedProtocolMessageType('HashingAlgorithm', (_message.Message,), {
  'DESCRIPTOR' : _HASHINGALGORITHM,
  '__module__' : 'snakeskin.protos.common.configuration_pb2'
  # @@protoc_insertion_point(class_scope:common.HashingAlgorithm)
  })
_sym_db.RegisterMessage(HashingAlgorithm)

BlockDataHashingStructure = _reflection.GeneratedProtocolMessageType('BlockDataHashingStructure', (_message.Message,), {
...
OrdererAddresses = _reflection.GeneratedProtocolMessageType('OrdererAddresses', (_message.Message,), {
...
Consortium = _reflection.GeneratedProtocolMessageType('Consortium', (_message.Message,), {
