...
# source: snakeskin/protos/common/ledger.proto
...
BlockchainInfo = _reflection.GeneratedProtocolMessageType('BlockchainInfo', (_message.Message,), {
  ...
  '__module__' : 'snakeskin.protos.common.ledger_pb2'
