...
# source: snakeskin/protos/common/policies.proto
...
_SIGNATUREPOLICYENVELOPE.fields_by_name['identities'].message_type = snakeskin_dot_protos_dot_msp_dot_msp__principal__pb2._MSPPRINCIPAL
...
Policy = _reflection.GeneratedProtocolMessageType('Policy', (_message.Message,), {
  'DESCRIPTOR' : _POLICY,
  '__module__' : 'snakeskin.protos.common.policies_pb2'
  # @@protoc_insertion_point(class_scope:common.Policy)
  })
_sym_db.RegisterMessage(Policy)

SignaturePolicyEnvelope = _reflection.GeneratedProtocolMessageType('SignaturePolicyEnvelope', (_message.Message,), {
...
SignaturePolicy = _reflection.GeneratedProtocolMessageType('SignaturePolicy', (_message.Message,), {

  'NOutOf' : _reflection.GeneratedProtocolMessageType('NOutOf', (_message.Message,), {
...
ImplicitMetaPolicy = _reflection.GeneratedProtocolMessageType('ImplicitMetaPolicy', (_message.Message,), {
