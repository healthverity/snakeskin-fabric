...
# source: snakeskin/protos/msp/msp_principal.proto
...
MSPPrincipal = _reflection.GeneratedProtocolMessageType('MSPPrincipal', (_message.Message,), {
  'DESCRIPTOR' : _MSPPRINCIPAL,
  '__module__' : 'snakeskin.protos.msp.msp_principal_pb2'
  # @@protoc_insertion_point(class_scope:common.MSPPrincipal)
  })
_sym_db.RegisterMessage(MSPPrincipal)

OrganizationUnit = _reflection.GeneratedProtocolMessageType('OrganizationUnit', (_message.Message,), {
...
MSPRole = _reflection.GeneratedProtocolMessageType('MSPRole', (_message.Message,), {
  'DESCRIPTOR' : _MSPROLE,
  '__module__' : 'snakeskin.protos.msp.msp_principal_pb2'
...
MSPIdentityAnonymity = _reflection.GeneratedProtocolMessageType('MSPIdentityAnonymity', (_message.Message,), {
...
CombinedPrincipal = _reflection.GeneratedProtocolMessageType('CombinedPrincipal', (_message.Message,), {
