...
# source: snakeskin/protos/msp/identities.proto
...
SerializedIdentity = _reflection.GeneratedProtocolMessageType('SerializedIdentity', (_message.Message,), {
  'DESCRIPTOR' : _SERIALIZEDIDENTITY,
  '__module__' : 'snakeskin.protos.msp.identities_pb2'
  # @@protoc_insertion_point(class_scope:msp.SerializedIdentity)
  })
_sym_db.RegisterMessage(SerializedIdentity)

SerializedIdemixIdentity = _reflection.GeneratedProtocolMessageType('SerializedIdemixIdentity', (_message.Message,), {
