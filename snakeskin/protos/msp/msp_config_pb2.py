...
# source: snakeskin/protos/msp/msp_config.proto
...
MSPConfig = _reflection.GeneratedProtocolMessageType('MSPConfig', (_message.Message,), {
  'DESCRIPTOR' : _MSPCONFIG,
  '__module__' : 'snakeskin.protos.msp.msp_config_pb2'
  # @@protoc_insertion_point(class_scope:msp.MSPConfig)
  })
_sym_db.RegisterMessage(MSPConfig)

FabricMSPConfig = _reflection.GeneratedProtocolMessageType('FabricMSPConfig', (_message.Message,), {
...
FabricCryptoConfig = _reflection.GeneratedProtocolMessageType('FabricCryptoConfig', (_message.Message,), {
...
IdemixMSPConfig = _reflection.GeneratedProtocolMessageType('IdemixMSPConfig', (_message.Message,), {
...
IdemixMSPSignerConfig = _reflection.GeneratedProtocolMessageType('IdemixMSPSignerConfig', (_message.Message,), {
...
SigningIdentityInfo = _reflection.GeneratedProtocolMessageType('SigningIdentityInfo', (_message.Message,), {
...
FabricOUIdentifier = _reflection.GeneratedProtocolMessageType('FabricOUIdentifier', (_message.Message,), {
...
FabricNodeOUs = _reflection.GeneratedProtocolMessageType('FabricNodeOUs', (_message.Message,), {
